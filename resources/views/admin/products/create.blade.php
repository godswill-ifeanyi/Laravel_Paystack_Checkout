...
@section('content')
    <div id="products" class="page">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter product name">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="price" class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter product price">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" class="w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter product description"></textarea>
